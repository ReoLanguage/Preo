...
/**
  ...
  * Generates Springy graphs (http://getspringy.com): HTML with Javascript output.
  */
object Springy {
  ...
  /**
    ...
    * @return
    */
  def script(c: CoreConnector): String = {
...
"""
  ...
  def apply(c:CoreConnector): String =
    s"""<html>
<body>
...
//    val g = Graph(c)
  ...
  /**
    ...
    * @param file
    */
  def toFile(c:CoreConnector,file:File): Unit = {
    val (edges,nodes) = toSpringEdges(c)
    val spr = s"""<html>
<body>
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js"></script>
